export const languages = [
  ...
  {   id: 3,
    ...
    ' \n' +
    '在這個人體天然的運作過程中，藉由將先進的營養素組合物導入皮膚，將訊號進一步傳入軟組織以產生額外的保濕效果，提昇強力的濕潤感和豐盈的效果。\n' +
    ' \n' +
    '除了這種獨家的細胞訊號傳輸複方之外，Celavive產品更含有Olivol®植物性混合物，是由多種水果萃取物所組成。臨床顯示，只要使用一次，就能24小時持續提供豐富的水分。',
    ...
    {   id: 7,
      ...
      introheader: "Cuidado de la piel de alto desempeño formulado con InCelligence®",
        ...
        'responde de manera única a las necesidades de cada persona, mejorando el tono y la textura,' +
        'y reduciendo dramáticamente la aparición de arrugas.Mediante el uso de sustancias botánicas ' +
        'naturales y poderosos péptidos para apoyar la capacidad natural de renovación de su ' +
        'cuerpo, su tez comenzará a verse más saludable, más radiante e increíblemente restaurada.' +
      ...
      incellheader: 'INCELLIGENCE®\n',
        ...
        ' ocasionado por el estrés del estilo de vida, como líneas finas y arrugas, aportando' +
        ' nutrientes clave a la piel. Además, estos ingredientes de belleza clave apoyan la ' +
        'producción natural de lípidos de su cuerpo y ayudan a reforzar seis importantes elementos ' +
        'que favorecen el mantenimiento de una matriz dérmica saludable, incluyendo colágeno, ' +
        'elastina y ácido hialuróico, para gozar de una piel de apariencia más joven.Como parte ' +
        'de este proceso natural, y mediante la aplicación de avanzadas combinaciones de nutrientes ' +
        'en la piel, se produce una humectación adicional gracias a nutrientes que penetran en las ' +
    ...
    {   id: 8,
      ...
      'grain irrégulier et rides – améliorant ainsi nettement l’apparence de la peau. ',
        ...
        'innée de la peau de se renouveler afin d’activer les fonctions qui préservent la jeunesse, ce qui va ' +
        'bien au-delà des régimes de soins de la peau traditionnels. Comme l’approche Celavive est globale, ' +
        'les produits répondent aux besoins particuliers de chacun; le tonus et le grain de la peau paraissent ' +
        'améliorés et l’apparence des rides, visiblement atténuée.Grâce à des végétaux naturels et des ' +
        'peptides puissants qui favorisent la capacité innée de l’organisme à se renouveler, le teint paraît plus ' +
        'sain et plus radieux, tandis que la peau est admirablement reconstituée.Découvrez la capacité innée de la peau ' +
      ...
      incellheader: 'INCELLIGENCE® \n',
        ...
        'incorporant à la peau des nutriments importants. De plus, ces ingrédients favorisent la production' +
        ' naturelle de lipides dans l’organisme et aident à renforcer six éléments clés qui peuvent contribuer ' +
        'à préserver l’apparence saine de la matrice cutanée, dont le collagène, l’élastine et l’acide  hyaluronique,' +
        ' afin que la peau paraisse remarquablement plus jeune. Par ce processus naturel et l’intégration de ' +
        'combinaisons de nutriments perfectionnés dans l’épiderme, l\'hydratation est accrue grâce à des ' +
        'ingrédients pénétrant plus en profondeur dans les couches supérieures de la peau, favorisant ' +
    ...
    {   id: 9,
      ...
      ' texturii și ridurile, îmbunătățind în mod dramatic aspectul pielii dumneavoastră. \n',
        ...
        'în funcțiune funcțiile de întreținere a frumuseții, mergând dincolo de regimurile tradiționale de îngrijire a' +
        ' pielii. Această abordare cuprinzătoare înseamnă că Celavive suscită un răspuns unic în cazul individual al' +
        ' fiecărei persoane, îmbunătățind aspectul tonalității și texturii pielii și reducând dramatic, în același timp, ' +
        'apariția ridurilor.Utilizând extracte naturale din plante și peptide puternice pentru a susține capacitățile ' +
        'naturale regenerative ale corpului dumneavoastră, tenul dumneavoastră va începe să arate mai sănătos, mai ' +
        'radiant și incredibil de bine restabilit.Descoperiți capacitatea naturală a pielii de a lupta împotriva ' +
      ...
      incellheader: 'INCELLIGENCE® \n',
        ...
        'stilul de viață, precum liniile fine și ridurile, introducând nutrienți esențiali în piele. În plus, aceste' +
        ' ingrediente esențiale ale frumuseții susțin producția naturală de lipide a corpului și ajută la susținerea a ' +
        'șase elemente majore care pot facilita menținerea unei matrice cu aspect sănătos a pielii, incluzând colagen, ' +
        'elastină și acid hialuronic, pentru o piele cu aspect evident întinerit.Ca parte a acestui proces natural și ' +
        'prin introducerea unor combinații avansate de nutrienți la nivelul pielii, se produce o hidratare suplimentară ' +
        'provenită din ingredientele care penetrează stratul superficial al pielii, promovând senzația de hidratare ' +
    ...
    {   id: 10,
      ...
      founded: 'Made with InCelligence® The exclusive Celavive Complex is made up of two bioactive peptides and two ' +
        'botanical extracts. When combined, these ingredients work to help counteract visible signs of chronological ' +
        'and lifestyle stress aging like fine lines and wrinkles by introducing key nutrients onto the skin. Plus, ' +
        'these key beauty ingredients support your body’s own natural lipid production and help support six major ' +
        'elements that can help maintain a healthy-looking skin matrix, including collagen, elastin, and hyaluronic ' +
        'acid, for noticeably younger-looking skin. As part of this natural process, and by introducing advanced ' +
        'nutrient combinations onto the skin, additional moisturisation is produced from ingredients that penetrate ' +
        'into the upper layers of the skin, promoting the feeling of intense hydration and plumping effects. ' +
    ...
    {   id: 11,
      ...
      introheader: 'INCELLIGENCE®\n',
        ...
        'glättet Falten, unterstützt anhand zielgerichtet wirkender Nährstoffkombinationen die natürliche Erneuerungsfähigkeit ' +
        'der Haut und bewahrt so ihre Jugendlichkeit.natürlicher Pflanzenstoffe und leistungsstarker Peptide wird Ihre Haut ' +
        'schon bald gesünder, strahlender und deutlich frischer aussehen.  \n' +
        'Unterstützen Sie Ihre Haut mit Celavive beim Kampf gegen die Alterung.\n',
      flag: './../../img/countryflag/de.png',

      incellheader: 'InCelligence \n',
        founded: 'Der einzigartige Celavive-Komplex wird aus zwei bioaktiven Peptiden und zwei pflanzlichen Extrakten ' +
        'hergestellt. Diese Bestandteile sorgen dafür, dass Ihre Haut weniger schnell altert. Zudem wirken sie der' +
        ' Linien- und Faltenbildung entgegen, indem sie Ihre Haut mit wichtigen Nährstoffen versorgen. Darüber hinaus ' +
        'unterstützen sie die körpereigene Lipidproduktion und tragen zur Aktivierung von sechs Hauptfaktoren bei, darunter ' +
        'Kollagen, Elastin und Hyaluronsäure. Dadurch wirkt Ihre Haut merklich jünger und gesünder. Neben diesem einzigartigen' +
  ...
  {   id: 13,
    ...
    'l’aspetto giovane, andando oltre i tradizionali programmi di cura della pelle. Questo approccio globale significa ' +
    'che Celavive risponde in modo mirato alle esigenze di ciascuno, migliorando il tono e la struttura della pelle e ' +
    'riducendo significativamente le rughe.Utilizzando preparati botanici naturali e potenti peptidi che supportano le ' +
    'naturali capacità di rinnovamento dell’organismo, la tua carnagione apparirà progressivamente più sana, più luminosa ' +
    'e incredibilmente più sana.Scopri la capacità naturale della tua pelle di combattere linvecchiamento visibile.',
    flag: './../../img/countryflag/lt.png',
    incellheader: 'Realizzato con InCelligence® \n',
    founded: 'L\'esclusivo complesso Celavive è costituito da due peptidi bioattivi e da due estratti botanici. Insieme, ' +
    'questi ingredienti contribuiscono a contrastare i segni visibili dell’invecchiamento e dello stress, che si traducono ' +
    'in linee sottili e rughe, grazie all’apporto di nutrienti fondamentali. Inoltre, questi ingredienti chiave di ' +
    'bellezza prouovono la produzione naturale di lipi da parte dell’organismo e aiutano a supportare sei elementi ' +
    'principali che possono aiutare a mantenere una pelle sana, compresi collagene, elastina e acido ialuronico, per ' +
    'una pelle decisamente più giovane.Nell’ambito di questo processo naturale e introducendo combinazioni di nutrienti ' +
  ...
  {   id: 16,
    ...
    science: 'ユサナが開発したインセリジェンス® テクノロジー、今度は本来もっている美の力を開放することに採用。最新の科学を基に厳選した栄養素を組み合わせることで、セラヴィブは、本来もっている肌の力を目覚めさせ、みずみずしい肌へ導いていきます。一人一人異なる肌のニーズに働きかけます。\n' +
    '自然植物成分とペプチド*を配合し、本来もっている美の力を引き出することで、肌がもっと健康的で、輝きを増し、' +
    'リフレッシュされていきます。みずみずしく輝いた肌へ、肌に秘められた自然の力を体感しましょう。\n',
  ...
  {   id: 17,
    ...
    science: '셀라비브는 전 세계를 선도하는 유사나의 과학자들과 스킨케어 전문가들의 기술력으로 탄생한 혁신적인 제품입니다.' +
    '셀라비브는 유사나만의 영양소 포뮬라로  평범한 스킨케어 제품에서는 경험할 수 없는 더욱 밝고 매끄러운 피부로 보일 수 있도록 가꾸어줍니다. 셀라비브의 포뮬라는 ' +
    '개인의 특성에 맞게 피부톤과 텍스처를 더욱 부드럽고 고르게 유지하며 더욱 매끄럽고 윤기 있게 가꾸어줍니다. ' +
    '다양한 식물성 추출물 블렌드와 펩타이드 성분이 함유된 셀라비브 스킨케어 제품은 건강하고 아름다운 피부를 오래도록 유지해줍니다.' +
    '유사나만이 제공하는 새로운 스킨케어 시스템으로 피부 본연의 건강함과 아름다움을 찾으세요.\n',
    flag: './../../img/countryflag/kr.png',

    incellheader: '유사나만의 기술력\n',
    founded: '유사나만의 셀라비브 컴플렉스는 두 가지 활성 펩타이드 성분과 두 가지 식물성 추출물 블렌드로 구성되어 있습니다. 이 두 가지 성분이 함께 작용하면 ' +
  ...
  {   id: 19,
    ...
    science: '全球营养学的领先者和InCelligence®技术的开发团队发现了一种专门解决您的美容特殊需求的新方法。Celavive使用针对性的营养素组合，可唤醒您皮肤的天然更新能力，启动人体常保青春的机能，超越了传统的护肤法。这种全面性的方法，意味着Celavive对每个人都有独特的效果，能改善皮肤色调和肤质，同时明显减少皱纹的出现。通过使用天然植物性成份和强大的胜肽来支持您身体天然的更新能力，您的肤色将开始变得更健康、更亮丽，还有惊人的修复力。发掘皮肤对抗明显老化迹象的天然能力。',
    incellheader: '采用InCelligence®\n ',
    flag: './../../img/countryflag/my.png',

    founded: '独家的Celavive复方系由两种生物活性胜肽和两种植物萃取物所组成。结合在一起，这些成份会将关键的营养素导入皮肤中，帮助抵消老化的迹象，例如细纹和皱纹。此外，这些关键美容成份能支持人体脂质的天然产生过程，帮助支持能维持健康外观皮肤基质的六个元素，包含胶原蛋白、弹性蛋白、和玻尿酸，使您的肌肤看起来更年轻。\n' +
    ' \n' +
  ...
  {   id: 21,
    ...
    science: 'ผู้นำด้านโภชนาการและผู้สร้างสรรค์เทคโนโลยีอินเซลลิเจนซ์ได้ค้นพบวิธีในการตอบสนองความต้องการด้านความงามที่เฉพาะของคุณ\n' +
    '\n' +
    ...
    '\n' +
    'ส่วนผสมของสารสกัดจากพฤกษชาติและเปปไทด์อันทรงพลังช่วยส่งเสริมความสามารถตามธรรมชาติของร่างกายซึ่งทำให้ผิวของคุณแลดูมีสุขภาพดี เปล่งปลั่ง และแข็งแรงขึ้นอย่างน่าอัศจรรย์\n' +
    '\n' +
    'ค้นพบความสามารถตามธรรมชาติของผิวเพื่อรักษาผิวสวยของคุณให้แลดูอ่อนเยาว์และเปล่งปลั่งตามที่คุณปรารถนา\n',
    incellheader: 'พัฒนาขึ้นด้วยเทคโนโลยีอินเซลลิเจนซ์\n',
    flag: './../../img/countryflag/th.png',

    founded: 'ส่วนผสมสูตรพิเศษในเซลาวีฟประกอบด้วยไบโอแอคทีฟ เปปไทด์ 2 ชนิดและสารสกัดจากพฤกษชาติ 2 ชนิดที่ทำงานร่วมกันเพื่อต่อต้านสัญญาณแห่งวัยที่มองเห็นได้ชัด เช่น ริ้วรอยเหี่ยวย่น โดยการนำสารอาหารสำคัญเข้าสู่ผิว นอกจากนี้ส่วนผสมเพื่อความงามที่สำคัญเหล่านี้ยังส่งเสริมการผลิตไขมันตามธรรมชาติของร่างกายและช่วยกระตุ้นองค์ประกอบที่เกิดขึ้นตามธรรมชาติ 6 ชนิดที่สามารถช่วยรักษาผิวให้มีสุขภาพดีซึ่งรวมถึงคอลลาเจน, อิลาสติน และกรดไฮยาลูโรนิก เพื่อให้ผิวแลดูอ่อนเยาว์อย่างเห็นได้ชัด\n' +
    ' \n' +
  ...
  {   id: 23,
    ...
    'by introducing key nutrients into the skin. Plus, these key beauty ingredients support your body’s own natural lipid production and help reinforce six major elements that can help maintain a healthy skin matrix, including collagen, elastin, and hyaluronic acid, for noticeably younger-looking skin.' +
    'As part of this natural process, and by introducing advanced nutrient combinations into the skin, additional moisturization is produced from signals sent further into the soft layer, promoting the feeling of intense hydration and plumping effects.' +
    'In addition to this exclusive complex, Celavive products also feature Olivol™ Botanical Blend, which is comprised of fruit extracts that have been clinically shown to provide 24 hours of rich hydration after just one application.',
    ctabutton: 'Sign Up For Celavive Updates\n',
    modalheader: 'Your first look at the future of skincare!\n Product Available',
    modalearly: 'early 2018',
    modalsub: 'Subscribe for updates\n',
  ...
  {   id: 25,
    ...
    'ingrédients pénétrant plus en profondeur dans les couches supérieures de la peau, favorisant ' +
    'ainsi une sensation d’hydratation intensive et des effets raffermissants.Outre ce complexe exclusif, ' +
    'les produits Celavive misent aussi sur le mélange végétal OlivolMC, fait d’extraits de fruits éprouvés en ' +
    'clinique pour assurer une riche hydratation pendant 24 heures après une seule application.',
    ctabutton: 'Abonnement aux mises à jour Celavive\n',
    modalheader: 'Aperçu en primeur de l’avenir des soins de beauté! \n \n',
    modalearly: 'Produit disponible au début de 2018  \n',
  ...
  {   id: 27,
    ...
    ' \n' +
    'Selain bahan kompleks yang eksklusif ini, produk-produk Celavive juga memiliki Olivol Botanical Blend, yang mengandung ekstrak buah yang memberikan hidrasi berlimpah setelah hanya satu kali pemakaian.\n',
